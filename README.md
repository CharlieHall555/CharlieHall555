<section>
  ...
  <ul>
    ...
    <li>
      ...
      <ul>
        <li>
          🗳️ <strong>Internet Voting System</strong> — I Developed an innovative internet voting approach for my final year project, using a custom blockchain to ensure transparent and secure voting.
